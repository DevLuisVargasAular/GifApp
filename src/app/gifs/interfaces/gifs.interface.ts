// To parse this data:
//
//   import { Convert, BuscarGifs } from "./file";
//
//   const buscarGifs = Convert.toBuscarGifs(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BuscarGifs {
    data:       Gif[];
...
export class Convert {
    public static toBuscarGifs(json: string): BuscarGifs {
        return cast(JSON.parse(json), r("BuscarGifs"));
    }

    public static buscarGifsToJson(value: BuscarGifs): string {
        return JSON.stringify(uncast(value, r("BuscarGifs")), null, 2);
    }
}
